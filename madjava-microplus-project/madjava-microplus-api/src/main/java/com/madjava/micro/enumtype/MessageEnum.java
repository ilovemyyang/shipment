...
public enum MessageEnum {
	...
	RELEASELOCK_NOTALLOW(20012, "没有权限释放锁"),
	RELEASELOCK_ERROR(20013, "释放锁失败"),
	...
	NOT_EXISTING_ONLINEPAGE(40016, "online页面信息不存在"),
	UPDATE_COMMON_CONMPONENT_FAIL(40017, "通用组件信息更新失败"),
	LOG_PAGE_STATUS_FAIL(40018, "记录页面状态更新记录失败"),
