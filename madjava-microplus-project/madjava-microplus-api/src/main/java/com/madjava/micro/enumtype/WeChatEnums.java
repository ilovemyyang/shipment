...
public class WeChatEnums {
	
	public enum WeChatRequestResponse
	{
	...
	public enum WeChatPayTypes
	{
		PAY, REFUND
	}

	public enum WeChatPayMagicNum
	{
		RFD
	}
}
