...
-- ----------------------------
BEGIN;
INSERT INTO `channel` VALUES (1, 'wmall', 'channelName', b'0', 1);
INSERT INTO `channel` VALUES (2, 'app', 'channelName2', b'0', 2);
COMMIT;
...
CREATE TABLE `channellp` (
  ...
  `channel_code` varchar(50) NOT NULL COMMENT '平台编码',
...
-- ----------------------------
BEGIN;
INSERT INTO `language` VALUES ('1', 'zh_CN', '中文', '2020-03-23 21:06:34', NULL, '2020-03-23 21:06:42', NULL);
INSERT INTO `language` VALUES ('2', 'en_US', '英文', '2020-03-23 21:07:04', NULL, '2020-03-23 21:07:04', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `platform` VALUES (1, '1', 'platformID');
INSERT INTO `platform` VALUES (2, '2', 'platform2');
COMMIT;
