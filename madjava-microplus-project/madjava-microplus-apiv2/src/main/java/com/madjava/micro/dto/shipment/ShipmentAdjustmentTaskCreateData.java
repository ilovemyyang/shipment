...
/**
 * @Classname ShipmentAdjustmentTaskCreateData
 * @Description 出货调整任务创建记录Data
 * @Date 2020-05-18 00:23:14
 * @Created by yibin.lu
 */
@Data
public class ShipmentAdjustmentTaskCreateData extends BaseData {

	private static final long serialVersionUID = 7264487868408532138L;
