...
/**
 * @Classname ShipmentNodeRouteLineCreateData
 * @Description 节点路由关系表创建记录Data
 * @Date 2020-05-18 00:23:14
 * @Created by yibin.lu
 */
@Data
public class ShipmentNodeRouteLineCreateData extends BaseData {

	private static final long serialVersionUID = -8413480284942491424L;
