...
/**
 * @Classname ShipmentNodeParentLineQueryData
 * @Description 节点父节点对应关系表创建记录Data
 * @Date 2020-05-18 00:23:14
 * @Created by yibin.lu
 */
@Data
public class ShipmentNodeParentLineQueryData extends PageData {

	private static final long serialVersionUID = -5389032579479478182L;
