...
@Configuration
@ComponentScan({"com.madjava.micro.utils", "com.madjava.micro.service", "com.madjava.micro.factory"})
public class AutoConfig {
   ...
   * 日志管理器
   */
  private Logger logger = LogManager.getLogger(AutoConfig.class.getName());

  @Primary
  @Bean(name = "microMessageSource")
